...
**Some numeric column values gave a range of values rather than one set value, so they were split into two respective columns: low and high. The first column to be split as such was the water temperature column (STILL WORKING ON IT CODEWISE): **
